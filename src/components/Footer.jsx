...
const Footer = () => {
  return (
    <Box sx={{ bgcolor: '#1A1A1A', pt: 8, pb: 4, mt: 'auto', borderTop: '1px solid rgba(212, 175, 55, 0.1)' }}>
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ mt: 3 }}>
              <IconButton sx={{ color: 'white', '&:hover': { color: '#D4AF37' } }}><FacebookIcon /></IconButton>
              <IconButton sx={{ color: 'white', '&:hover': { color: '#D4AF37' } }}><TwitterIcon /></IconButton>
              <IconButton sx={{ color: 'white', '&:hover': { color: '#D4AF37' } }}><LinkedInIcon /></IconButton>
              <IconButton sx={{ color: 'white', '&:hover': { color: '#D4AF37' } }}><InstagramIcon /></IconButton>
            </Box>
          </Grid>
          
          <Grid item xs={6} md={2}>
            <Typography variant="h6" sx={{ color: 'white', mb: 2 }}>Platform</Typography>
          ...
          <Grid item xs={6} md={2}>
            <Typography variant="h6" sx={{ color: 'white', mb: 2 }}>Support</Typography>
