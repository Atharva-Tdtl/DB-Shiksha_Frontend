...
const Contact = () => {
  ...
  return (
    <SectionWrapper title="Get In Touch" subtitle="Have questions about our AI programs? Our team is here to help you choose the right path.">
      <Grid container spacing={6}>
        <Grid item xs={12} md={5}>
          <Box sx={{ mb: 4 }}>
            <Typography variant="h5" sx={{ mb: 3 }}>Contact Information</Typography>
            <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
              <IconButton sx={{ bgcolor: 'rgba(212,175,55,0.1)', color: '#D4AF37' }}><EmailIcon /></IconButton>
              <Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>Email</Typography>
                <Typography color="text.secondary">support@dbshiksha.com</Typography>
              </Box>
            </Box>
            <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
              <IconButton sx={{ bgcolor: 'rgba(212,175,55,0.1)', color: '#D4AF37' }}><PhoneIcon /></IconButton>
              <Box>
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              <IconButton sx={{ bgcolor: 'rgba(212,175,55,0.1)', color: '#D4AF37' }}><LocationOnIcon /></IconButton>
              <Box>
                <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>Location</Typography>
                <Typography color="text.secondary">Bangalore, Karnataka, India</Typography>
              </Box>
            </Box>
          </Box>
        ...
        <Grid item xs={12} md={7}>
          <Paper component="form" onSubmit={handleSubmit} sx={{ p: { xs: 3, md: 5 } }}>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <ButtonPrimary type="submit" fullWidth size="large">Send Message</ButtonPrimary>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
